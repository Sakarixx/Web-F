  ...
  <body>
    ...
    <div class="w3-container">
      <div class="w3-content">
        <div class="w3-col s3 m3 l3"> <a class="w3-button w3-indigo" href="form_insert.php">เพิ่มนักศึกษาใหม่</a></div>
      </div>
...
<a class="w3-button w3-orange" href="form_edit.php?sid=<?php echo $data_1['SID']; ?>">แก้ไขข้อมูล</a>
</div>
          <div class="w3-col w3-padding" style="width:10%;">
