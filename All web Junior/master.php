...
<html lang="en" dir="ltr">
  ...
  while ($data_1 = mysql_fetch_array($qry_1)) { ?>
    ...
    <div class="w3-row w3-amber w3-border-bottom w3-border-black">
      <div class="w3-col w3-center" style="width:5%;"><?php echo $data_1['Id']; ?></div>
      <div class="w3-col" style="width:10%;"><?php echo $data_1['Sname']; ?></div>
      <div class="w3-col w3-padding" style="width:10%;"> <a class="w3-button w3-orange" href="detail.php?Id=<?php echo $data_1['Id']; ?>">แสดงหนังสือ</a>  </div>
    </div>
